                ...
                <div class="panel-body">
                    <form id="queryForm" class="form-inline" role="form" style="float:left;" action="${PATH}/admin/index" method="post">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input name="condition" class="form-control has-success" value="${param.condition}" type="text" placeholder="请输入查询条件">
                            </div>
                        </div>
                        <button onclick="$('#queryForm').submit()" type="button" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> 查询</button>
                    </form>
                    ...
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <c:forEach items="${page.list}" var="admin" varStatus="i">
                                <tr>
                                    <td>${i.count}</td>
                                    ...
                                    <td>${admin.email}</td>
                                    <td>
                                        <button type="button" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check" onclick="window.location.href='${PATH}/admin/toAssign?id=${admin.id}'"></i></button>
                                        <button type="button" class="btn btn-primary btn-xs" onclick="window.location.href='${PATH}/admin/toUpdate?id=${admin.id}&pageNum=${page.pageNum}&condition=${param.condition}'"><i class=" glyphicon glyphicon-pencil"></i></button>
